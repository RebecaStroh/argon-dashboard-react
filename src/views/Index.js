  ...
  return (
    <>
      ...
      <Container className="mt--5" fluid>
        ...
        {viewType === "scoreGraphicView" && <DataGraph graphName="Gráfico de pontuação Qualis" init={initYearInput} end={endYearInput} stats={stats} showStatistics={showStatistics} score/>}
